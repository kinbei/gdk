...
#include <util/refcount.h>
	...
	typedef unsigned (__stdcall * START_ROUTINE_TYPE)( void * );
...
public:
	 ...
	 * 
	 */
	int32 initialize( START_ROUTINE_TYPE pRoutine, void* pArglist )
	{
		m_pRoutine = pRoutine;
		...
		m_hThread = (HANDLE)_beginthreadex( NULL, 0, Routine, (void*)this, 0, &nThreadID );

		// _beginthreadex returns 0 on an error, in which case errno and _doserrno are set.
		if ( m_hThread == NULL )
			return _doserrno;
#else
		int32 nRetCode = pthread_create(&this->m_hThread, NULL, Routine, (void*)this );
		if ( nRetCode != 0 )
		{
			this->m_hThread = 0;
			return nRetCode;
	 ...
	 */
#ifdef WINDOWS
	static unsigned __stdcall Routine( void * pArglist )
#else
	static void* Routine( void * pArglist )
#endif
	{
